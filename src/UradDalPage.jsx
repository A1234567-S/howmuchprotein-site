...
export default function UradDalPage() {
  ...
  const calculateProtein = () => {
    ...
    const calories = unit === 'grams'
      ? Math.round(quantity * 3.41)
      : Math.round(quantity * 341);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <div className="text-sm text-gray-600 mb-4">
          ...
          <span className="text-gray-900 ml-1">Urad Dal</span>
        </div>

        <div className="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl p-8 text-white mb-8">
          <h1 className="text-4xl font-bold mb-4">How Much Protein in Urad Dal?</h1>
          <div className="text-6xl font-bold mb-2">27g</div>
          <div className="text-xl text-indigo-100">per 100g</div>
        </div>

        <div className="grid md:grid-cols-3 gap-4 mb-8">
          <div className="bg-white rounded-lg p-6 shadow-md">
            <div className="text-3xl font-bold text-gray-900 mb-2">27g</div>
            <div className="text-gray-600">protein per 100g</div>
          </div>
          <div className="bg-white rounded-lg p-6 shadow-md">
            <div className="text-3xl font-bold text-gray-900 mb-2">341</div>
        ...
        <article className="bg-white rounded-2xl p-8 shadow-md mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">About Urad Dal</h2>
          <p className="text-gray-700 mb-6">
            Urad Dal is a nutritious food that provides 27g of protein per 100g serving. 
            With 341 calories per 100g, it's an energy-dense protein source.
          </p>

          <h3 className="text-xl font-bold text-gray-900 mb-3">Nutritional Profile</h3>
          <ul className="list-disc list-inside text-gray-700 space-y-2 mb-6">
            <li><strong>Protein:</strong> 27g per 100g</li>
            <li><strong>Calories:</strong> 341 per 100g</li>
            <li><strong>Fat:</strong> 1.6g per 100g</li>
            <li><strong>Protein-to-Calorie Ratio:</strong> 7.9%</li>
          </ul>

          <h3 className="text-xl font-bold text-gray-900 mb-3">How Urad Dal Fits Your Daily Protein Needs</h3>
          <div className="bg-gray-50 rounded-lg p-6 mb-6">
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-gray-700">For 54g daily protein goal:</span>
                <span className="text-indigo-600 font-semibold">200g of Urad Dal</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-700">For 109g daily protein goal:</span>
                <span className="text-indigo-600 font-semibold">404g of Urad Dal</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-700">For 150g daily protein goal:</span>
                <span className="text-indigo-600 font-semibold">556g of Urad Dal</span>
              </div>
            </div>
          </div>
