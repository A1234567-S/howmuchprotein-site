...
export default function MasoorDalPage() {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <div className="text-sm text-gray-600 mb-4">
          ...
          <span className="text-gray-900 ml-1">Masoor Dal</span>
        </div>

        <div className="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl p-8 text-white mb-8">
          <h1 className="text-4xl font-bold mb-4">How Much Protein in Masoor Dal?</h1>
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-8">
          ...
          <div className="bg-white rounded-lg p-6 shadow-md">
            <div className="text-3xl font-bold text-gray-900 mb-2">1.3g</div>
        ...
        <article className="bg-white rounded-2xl p-8 shadow-md mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">About Masoor Dal</h2>
          <p className="text-gray-700 mb-6">
            Masoor Dal is a nutritious food that provides 25g of protein per 100g serving. 
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-2 mb-6">
            ...
            <li><strong>Fat:</strong> 1.3g per 100g</li>
            <li><strong>Protein-to-Calorie Ratio:</strong> 6.9%</li>
          </ul>

          <h3 className="text-xl font-bold text-gray-900 mb-3">How Masoor Dal Fits Your Daily Protein Needs</h3>
          <div className="bg-gray-50 rounded-lg p-6 mb-6">
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-gray-700">For 54g daily protein goal:</span>
                <span className="text-indigo-600 font-semibold">216g of Masoor Dal</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-700">For 109g daily protein goal:</span>
                <span className="text-indigo-600 font-semibold">436g of Masoor Dal</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-700">For 150g daily protein goal:</span>
                <span className="text-indigo-600 font-semibold">600g of Masoor Dal</span>
              </div>
            </div>
          </div>
